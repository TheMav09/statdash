...
import {
  ...
  Navigate,
  Outlet,
} from "react-router-dom"; // Routing components from react-router-dom
        ...
        <Router>
          <Routes>
            ...
            <Route element={<NavbarTest />}>
              ...
              <Route path="/vms-by-tags" element={<AzureVmsByTag />} />{" "}
              {/* New route for VMs by tag */}
